...
/// `reference_sql` (the canonical solution) is hidden and used to grade.
...
/// The four standard tags plus a `vgi.example_queries` demo (VGI306/VGI506) for
/// a scalar/table function.
pub fn object_tags_with_example(
    ...
    let mut tags = object_tags(title, description_llm, description_md, keywords);
    tags.push((
